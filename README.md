# Ruby service for Wodby

Use Ruby as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Ruby service in the Wodby catalog.
...
4. Reference `ruby` from your stack manifest.
